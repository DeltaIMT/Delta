...
class ActorPerPlayer(id: String, playerActorRef: ActorRef) extends Actor {
  ...
  var player = Player(PlayerData(id, Vector(50+rand.nextInt(4900),50+1*rand.nextInt(4900))  :: List.empty[Vector], 50, rand.nextDouble(), 10, 10, Array(rand.nextInt(255), rand.nextInt(255), rand.nextInt(255)), null), playerActorRef)
  var message = ""
