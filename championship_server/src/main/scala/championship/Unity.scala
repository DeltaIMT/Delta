...
class Splash(var x : Double, var y : Double, var id : String, val kind : String)  extends Element  {
  var lifeLeft = 30
...
class Boat(var x: Double, var y: Double, var id: String) extends Element with Observable {
  ...
  var fusionTargetId = ""
  var fusionTargetPosition : Option[Vec]= None
